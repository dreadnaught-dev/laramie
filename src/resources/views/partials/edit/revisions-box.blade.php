<div class="card revision-history">
    ...
    <div id="revisions-card-content" class="card-content {{ $hideRevisions ? 'is-hidden' : '' }}">
        <div class="revision-item">
            <span title="by: {{ data_get($lastUserToUpdate, config('laramie.username'), '--') }}">Current <em><small>({{ \Carbon\Carbon::parse($item->updated_at, config('laramie.timezone'))->toDayDateTimeString() }})</small></em></span>
            <div>
